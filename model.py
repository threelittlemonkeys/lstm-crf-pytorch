...
from utils import zeros, Tensor, LongTensor, log_sum_exp, randn
from parameters import RNN_TYPE, CUDA, NUM_LAYERS, HIDDEN_SIZE, NUM_DIRS, EMBED_SIZE, DROPOUT, BATCH_SIZE, \
    EOS_IDX, SOS_IDX, PAD_IDX, UNK_IDX
